...
type ProfileCardHeaderDeprecatedProps = PropsWithClassName;

const ProfileCardHeaderDeprecated = (props: ProfileCardHeaderDeprecatedProps) => {
...
export default ProfileCardHeaderDeprecated;
